...
// console.log(planetDistanceFromSun(mars)); // A
// setTimeout(() => console.log(planetDistanceFromSun(venus)), 3000); // B em 3segudos
// setTimeout(() => console.log(planetDistanceFromSun(jupiter)), 2000); // C em 3segudos
...
//   const currentTemperature = getMarsTemperature(); // chama a funcao declarada anterior
//   setTimeout(() => console.log(`Mars temperature is ${currentTemperature} degree`), messageDelay());
// };
...
//   const currentTemperature = getMarsTemperature(); // chama a funcao declarada anterior
//   const randomNumber = Math.random()//gera um num de 0 a 60% de chances retorna frase
//   const sentSuccessfully = randomNumber < 0.6; // de 0 a 60 deu certo de 60 a 100 deu errado
//   console.log(randomNumber, sentSuccessfully);
//   setTimeout(() => {
//     if(sentSuccessfully) {
